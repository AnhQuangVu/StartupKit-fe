            ...
            {accessUsers.map((user, idx) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() =>
                    setAccessUsers((users) => users.filter((_, i) => i !== idx))
                  }
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-lg shadow-lg p-6 w-[350px] max-w-full">
        ...
        <p className="text-xs mb-4">
          Bạn có chắc muốn xoá hồ sơ này khỏi dự án?
        </p>
        <div className="flex gap-2">
          <button
            className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded py-2"
            onClick={() => setShowDeleteModal(false)}
          >
            Huỷ
          </button>
          <button
            className="flex-1 bg-red-500 hover:bg-red-600 text-white font-medium rounded py-2"
            onClick={async () => {
              ...
              try {
                ...
                const res = await fetch(
                  `${API_BASE}/projects/${selectedProfile.id}`,
                  {
                    method: "DELETE",
                    headers: {
                      ...authHeaders(token),
                ...
                setProfiles((prev) =>
                  prev.filter((p) => p.id !== selectedProfile.id)
                );
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 py-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 md:px-8 -mt-4 py-10">
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4 h-fit">
            ...
            <button
              className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-medium rounded-md py-2 mb-4 flex items-center justify-center gap-2"
            ...
            {loading ? (
              <div className="flex justify-center items-center py-8">
                <svg
                  className="animate-spin h-6 w-6 text-yellow-400 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
                    ...
                    filteredProfiles.map((profile) => (
                      ...
                      >
                        ...
                        <div className="text-[10px] text-gray-400">
                          Giai đoạn: {getDisplayStage(profile.stage)} | Ngày
                          tạo:{" "}
                          {profile.created_at
          ...
          <div
            className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-lg p-6 flex flex-col"
            style={{
              maxHeight: "450px",
              minHeight: "300px",
              overflowY: "auto",
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <span className="inline-block px-2 py-0.5 rounded bg-yellow-100 text-yellow-700 text-xs font-medium">
                        {getDisplayStage(selectedProfile.stage)}
                      </span>
                    </div>
                    <div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="text-sm text-gray-700 whitespace-pre-line bg-gray-50 rounded p-3 border mt-1">
                ...
                <div className="flex justify-end gap-2 mt-auto">
                  <button
                    className="px-2 py-1 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 flex items-center gap-1 text-xs"
                  ...
                  <button
                    className="px-2 py-1 rounded bg-blue-100 hover:bg-blue-200 text-blue-700 flex items-center gap-1 text-xs"
                    style={{ minWidth: "unset" }}
                    onClick={() => setShowHistoryModal(selectedProfile?.name)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-3 w-3"
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11H9v-2h2v2zm0-3H9V8h2v2z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Lịch sử
                  ...
                  <button
                    className="px-2 py-1 rounded bg-red-100 hover:bg-red-200 text-red-700 flex items-center gap-1 text-xs"
                    style={{ minWidth: "unset" }}
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Xoá
