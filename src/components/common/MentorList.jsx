...
export default function MentorList({ small = false }) {
  const mentors = [
    {
  ...
  notableInvestments: ["BlogMaster", "DesignHub"],
    ...
    },
    {
      ...
      notableInvestments: ["TeamSync", "Foodie"],
      status: true,
      tag: "Mentor",
      button: "Kết nối",
    },
    {
      ...
      name: "Đ. Hùng",
      focus: "Chiến lược kinh doanh",
      notableInvestments: ["GreenTech", "ShopMaster"],
      status: true,
      tag: "Mentor",
      button: "Kết nối",
    },
  ...
  return (
    <section className="max-w-6xl mx-auto mt-5 text-center px-4 sm:px-6">
      ...
      {/* Render mentors in a single responsive grid to avoid empty/irregular rows */}
