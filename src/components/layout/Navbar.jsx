    ...
    <header className="w-full bg-white shadow-md border-b border-gray-100">
      <div className="flex items-center justify-between px-4 md:px-8 h-16">
        ...
        <div className="hidden md:flex gap-3 ml-8 items-center">
          {!isLoggedIn ? (
            ...
            <Link
              to="/Profile"
              className={`flex items-center hover:text-[#FFCE23] transition-colors ${
                location.pathname.startsWith("/Profile")
        ...
        {/* Mobile menu button */}
        <button
          className="md:hidden text-[#374151] text-2xl"
          onClick={toggleMenu}
      ...
      {showMenu && (
        <div className="md:hidden bg-white border-t border-gray-100 shadow-lg">
          <nav className="flex flex-col px-4 py-4 text-[#374151] text-sm font-medium space-y-4">
            <Link
              to="/dashboard"
              className={`cursor-pointer transition-colors duration-200 ${
                isActive(dashboardPaths)
            ...
            {!isLoggedIn ? (
              <>
                <button
                  className="bg-white border border-[#FFCE23] text-black font-semibold px-3 py-2 rounded-md text-sm hover:bg-[#FFF9E0] transition-all duration-200 w-full text-left"
                  onClick={() => {
                    handleRegister();
                    closeMenu();
                  }}
                ...
                <Link
                  to="/dang-nhap"
                  className="bg-[#FFCE23] text-black font-semibold px-3 py-2 rounded-md text-sm hover:bg-[#FFE066] transition-all duration-200 text-center"
                  onClick={closeMenu}
                >
                  Đăng Nhập
                </Link>
