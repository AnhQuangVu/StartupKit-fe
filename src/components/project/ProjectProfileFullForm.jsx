              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4 relative z-10">
                ...
                {idx === 0 && (
                  <div className="flex gap-3 order-2 sm:order-1">
                    <button
                      type="button"
                      className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 z-20"
                    ...
                    <PDFDownloadLink
                      ...
                      className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 no-underline z-20"
                      onClick={handleDownload}
                    >
                      {({ loading }) => (loading ? "Đang tạo..." : "Tải xuống")}
                    </PDFDownloadLink>
                    <button
                      type="button"
                      className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 z-20"
